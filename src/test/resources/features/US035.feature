...
Scenario:4-Verify that it is possible to search in the Product List with the Quick Search TextBox
...
Scenario:7-It should be verified that the Edit link is visible on the select tab in the Action column
...
Scenario:8-It should be verified that the current information of the product is available
...
Scenario: 11-It should be verified that the Clone link is visible on the select tab in the Action column
...
Scenario:12-Verify that Product Information, Price Info And Stock, Weight Height Info, Product Image Info,
Pdf Specifications, Product Video Info, Others Info information is
  ...
  * On the Clone Product page, Product Information, Price Info And Stock, Weight Height Info, Product Image Info, Pdf Specifications, It was seen that Product Video Info, Others Info information can be changed
  ...
  Scenario: 13-On the Save button, it should be verified that the message reminding that the
  ...
  Scenario: 14-After updating the information on the General Information, Related Product, Up Sale, Cross Sale pages, verify that the updated information is saved with the Save button.
    * Login to Trendlifeby page as admin
    * Go to Prouducts List page
  ...
  Scenario: 15-It should be verified that the Delete link is visible on the select tab in the Action column in the Product List and that the Delete operation can be performed when clicked.
    * Login to Trendlifeby page as admin
    * Go to Prouducts List page
